...
namespace Finbourne.Identity.Sdk.Api
{
    ...
    public interface IAuthenticationApiSync : IApiAccessor
    {
        ...
        ApiResponse<PasswordPolicy> GetPasswordPolicyWithHttpInfo(string userType);
        /// <summary>
    ...
    public interface IAuthenticationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PasswordPolicy> GetPasswordPolicyAsync(string userType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PasswordPolicy>> GetPasswordPolicyWithHttpInfoAsync(string userType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EARLY ACCESS] GetSupportAccessHistory: Get the history of all support access granted and any information pertaining to their termination
        /// </summary>
        /// <remarks>
    ...
    public partial class AuthenticationApi : IAuthenticationApi
    {
        ...
        /// <param name="userType">The type of user (should only be personal or service)</param>
        /// <returns>PasswordPolicy</returns>
        public PasswordPolicy GetPasswordPolicy(string userType)
        {
        ...
        /// <param name="userType">The type of user (should only be personal or service)</param>
        /// <returns>ApiResponse of PasswordPolicy</returns>
        public Finbourne.Identity.Sdk.Client.ApiResponse<PasswordPolicy> GetPasswordPolicyWithHttpInfo(string userType)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PasswordPolicy</returns>
        public async System.Threading.Tasks.Task<PasswordPolicy> GetPasswordPolicyAsync(string userType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Identity.Sdk.Client.ApiResponse<PasswordPolicy> localVarResponse = await GetPasswordPolicyWithHttpInfoAsync(userType, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PasswordPolicy)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Identity.Sdk.Client.ApiResponse<PasswordPolicy>> GetPasswordPolicyWithHttpInfoAsync(string userType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'userType' is set
            if (userType == null)
                throw new Finbourne.Identity.Sdk.Client.ApiException(400, "Missing required parameter 'userType' when calling AuthenticationApi->GetPasswordPolicy");
