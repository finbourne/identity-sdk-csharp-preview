...
namespace Finbourne.Identity.Sdk.Api
{
    ...
    public interface IAuthenticationApiSync : IApiAccessor
    {
        ...
        ApiResponse<PasswordPolicyDto> GetPasswordPolicyWithHttpInfo(string userType);
        /// <summary>
        ...
        /// <returns>PasswordPolicyDto</returns>
        PasswordPolicyDto UpdatePasswordPolicy(string userType, PasswordPolicyDto passwordPolicyDto = default(PasswordPolicyDto));
        ...
        /// <param name="passwordPolicyDto">The password policy for the given user type (optional)</param>
        /// <returns>ApiResponse of PasswordPolicyDto</returns>
        ApiResponse<PasswordPolicyDto> UpdatePasswordPolicyWithHttpInfo(string userType, PasswordPolicyDto passwordPolicyDto = default(PasswordPolicyDto));
    ...
    public interface IAuthenticationApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PasswordPolicyDto> GetPasswordPolicyAsync(string userType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PasswordPolicyDto>> GetPasswordPolicyWithHttpInfoAsync(string userType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// [EARLY ACCESS] GetSupportAccessHistory: Get the history of all support access granted and any information pertaining to their termination
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PasswordPolicyDto</returns>
        System.Threading.Tasks.Task<PasswordPolicyDto> UpdatePasswordPolicyAsync(string userType, PasswordPolicyDto passwordPolicyDto = default(PasswordPolicyDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PasswordPolicyDto)</returns>
        System.Threading.Tasks.Task<ApiResponse<PasswordPolicyDto>> UpdatePasswordPolicyWithHttpInfoAsync(string userType, PasswordPolicyDto passwordPolicyDto = default(PasswordPolicyDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class AuthenticationApi : IAuthenticationApi
    {
        ...
        /// <param name="userType">The type of user (should only be personal or service)</param>
        /// <returns>PasswordPolicyDto</returns>
        public PasswordPolicyDto GetPasswordPolicy(string userType)
        {
        ...
        /// <param name="userType">The type of user (should only be personal or service)</param>
        /// <returns>ApiResponse of PasswordPolicyDto</returns>
        public Finbourne.Identity.Sdk.Client.ApiResponse<PasswordPolicyDto> GetPasswordPolicyWithHttpInfo(string userType)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PasswordPolicyDto</returns>
        public async System.Threading.Tasks.Task<PasswordPolicyDto> GetPasswordPolicyAsync(string userType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Identity.Sdk.Client.ApiResponse<PasswordPolicyDto> localVarResponse = await GetPasswordPolicyWithHttpInfoAsync(userType, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (PasswordPolicyDto)</returns>
        public async System.Threading.Tasks.Task<Finbourne.Identity.Sdk.Client.ApiResponse<PasswordPolicyDto>> GetPasswordPolicyWithHttpInfoAsync(string userType, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'userType' is set
            if (userType == null)
                throw new Finbourne.Identity.Sdk.Client.ApiException(400, "Missing required parameter 'userType' when calling AuthenticationApi->GetPasswordPolicy");
        ...
        /// <param name="passwordPolicyDto">The password policy for the given user type (optional)</param>
        /// <returns>PasswordPolicyDto</returns>
        public PasswordPolicyDto UpdatePasswordPolicy(string userType, PasswordPolicyDto passwordPolicyDto = default(PasswordPolicyDto))
        {
        ...
        /// <param name="passwordPolicyDto">The password policy for the given user type (optional)</param>
        /// <returns>ApiResponse of PasswordPolicyDto</returns>
        public Finbourne.Identity.Sdk.Client.ApiResponse<PasswordPolicyDto> UpdatePasswordPolicyWithHttpInfo(string userType, PasswordPolicyDto passwordPolicyDto = default(PasswordPolicyDto))
        {
            // verify the required parameter 'userType' is set
            if (userType == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of PasswordPolicyDto</returns>
        public async System.Threading.Tasks.Task<PasswordPolicyDto> UpdatePasswordPolicyAsync(string userType, PasswordPolicyDto passwordPolicyDto = default(PasswordPolicyDto), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            Finbourne.Identity.Sdk.Client.ApiResponse<PasswordPolicyDto> localVarResponse = await UpdatePasswordPolicyWithHttpInfoAsync(userType, passwordPolicyDto, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
