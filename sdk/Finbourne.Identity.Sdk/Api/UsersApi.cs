...
namespace Finbourne.Identity.Sdk.Api
{
    ...
    public interface IUsersApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Finbourne.Identity.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The unique identifier for the User to suspend</param>
        /// <returns></returns>
        ...
        /// <param name="id">The unique identifier for the User to suspend</param>
        /// <returns>ApiResponse of Object(void)</returns>
        ApiResponse<Object> SuspendUserWithHttpInfo(string id);
        /// <summary>
    ...
    public partial class UsersApi : IUsersApi
    {
        ...
        /// <summary>
        /// [EXPERIMENTAL] SuspendUser: Suspend user suspend the user
        /// </summary>
        /// <exception cref="Finbourne.Identity.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id">The unique identifier for the User to suspend</param>
        /// <returns></returns>
        ...
        /// <param name="id">The unique identifier for the User to suspend</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Finbourne.Identity.Sdk.Client.ApiResponse<Object> SuspendUserWithHttpInfo(string id)
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Finbourne.Identity.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling UsersApi->SuspendUser");
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Post<Object>("/api/users/{id}/lifecycle/$suspend", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Finbourne.Identity.Sdk.Client.ApiResponse<Object>> SuspendUserWithHttpInfoAsync(string id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
                throw new Finbourne.Identity.Sdk.Client.ApiException(400, "Missing required parameter 'id' when calling UsersApi->SuspendUser");
            ...
            var localVarResponse = await this.AsynchronousClient.PostAsync<Object>("/api/users/{id}/lifecycle/$suspend", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
