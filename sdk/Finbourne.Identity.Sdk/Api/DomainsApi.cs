...
namespace Finbourne.Identity.Sdk.Api
{
    ...
    public interface IDomainsApiSync : IApiAccessor
    {
        ...
        ApiResponse<Object> GetAgreementWithHttpInfo(string agreement);
        /// <summary>
    ...
    public interface IDomainsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task GetAgreementAsync(string agreement, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> GetAgreementWithHttpInfoAsync(string agreement, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// GetMyDomain: Get current Domain
        /// </summary>
        /// <remarks>
    ...
    public partial class DomainsApi : IDomainsApi
    {
        ...
        /// <param name="agreement">Name of the agreement</param>
        /// <returns></returns>
        public void GetAgreement(string agreement)
        {
        ...
        /// <param name="agreement">Name of the agreement</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Finbourne.Identity.Sdk.Client.ApiResponse<Object> GetAgreementWithHttpInfo(string agreement)
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Head<Object>("/api/domains/me/agreements/{agreement}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task GetAgreementAsync(string agreement, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            await GetAgreementWithHttpInfoAsync(agreement, cancellationToken).ConfigureAwait(false);
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Finbourne.Identity.Sdk.Client.ApiResponse<Object>> GetAgreementWithHttpInfoAsync(string agreement, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'agreement' is set
            if (agreement == null)
                throw new Finbourne.Identity.Sdk.Client.ApiException(400, "Missing required parameter 'agreement' when calling DomainsApi->GetAgreement");
            ...
            var localVarResponse = await this.AsynchronousClient.HeadAsync<Object>("/api/domains/me/agreements/{agreement}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
