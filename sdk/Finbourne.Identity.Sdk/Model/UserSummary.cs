...
namespace Finbourne.Identity.Sdk.Model
{
    ...
    public partial class UserSummary : IEquatable<UserSummary>
    {
        ...
        public UserSummary(string id = default(string), string login = default(string), string email = default(string), string firstName = default(string), string lastName = default(string), string type = default(string), List<Link> links = default(List<Link>))
        {
            this.Id = id;
            this.Login = login;
            this.Email = email;
