...
namespace Finbourne.Identity.Sdk.Model
{
    ...
    public partial class CreateUserRequest : IEquatable<CreateUserRequest>
    {
        ...
        public CreateUserRequest(string firstName = default(string), string lastName = default(string), string emailAddress = default(string), string login = default(string), List<RoleId> roles = default(List<RoleId>), string type = default(string))
        {
