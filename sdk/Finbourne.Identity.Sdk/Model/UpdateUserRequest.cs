...
namespace Finbourne.Identity.Sdk.Model
{
    ...
    public partial class UpdateUserRequest : IEquatable<UpdateUserRequest>
    {
        ...
        public UpdateUserRequest(string firstName = default(string), string lastName = default(string), string emailAddress = default(string), string secondEmailAddress = default(string), string login = default(string))
        {
