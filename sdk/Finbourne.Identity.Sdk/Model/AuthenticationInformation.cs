...
namespace Finbourne.Identity.Sdk.Model
{
    ...
    public partial class AuthenticationInformation : IEquatable<AuthenticationInformation>
    {
        ...
        public AuthenticationInformation(string issuerUrl = default(string), string samlIdentityProviderId = default(string), SupportAccessExpiry support = default(SupportAccessExpiry), List<Link> links = default(List<Link>))
        {
